<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <a href="<?= base_url('certificate/tambah_certificate');?>" class="btn btn-primary" style="float: right;">
         + tambah
        </a>
            </div>
            <br>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <?php
                    ...
                    <td class="text-center" style="vertical-align: middle;"><?= $row->certificate_id ?></td>
                        ...
                        <td>
                        <a href="<?= base_url('certificate/edit_certificate/' . $row->certificate_id);?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                        <a href="<?= base_url('certificate/hapus_certificate/' . $row->certificate_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> hapus</a>
                    </tr>
                    <?php
                      }
                      ?>
