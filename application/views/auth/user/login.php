          ...
          <div class="row">
            <div class="col-xl-4 col-lg- col-md-7 d-flex flex-column mx-lg-auto mx-auto">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <!-- <form role="form"> -->
                    <form class="user" method="POST" action="<?= base_url('auth_user/login');?>">
                    <div class="mb-3">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="<?= base_url('auth_user/registrasi');?>" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
                <div class="buy-now">
                    <a
                    href="<?=base_url('auth_admin');?>"
                    target="_blank"
                    class="btn btn-primary btn-buy-now">Admin login in here</a>
                  </div>
              </div>
            </div>
