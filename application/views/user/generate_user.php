<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <a href="<?= base_url('gn_user/tambah_generate');?>" class="btn btn-primary" style="float: right;">
         + tambah certificate
        </a> -->
            </div>
            <br>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <?php
                    ...
                    <td class="text-center" style="vertical-align: middle;"><?= $row->assignment_id ?></td>
                        ...
                        <td>
                        <a href="<?= base_url('gn_user/download/' . $row->assignment_id);?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> download</a>
                        <!-- <a href="<?= base_url('gn_user/hapus_generate/' . $row->assignment_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> hapus</a> -->
                    </tr>
                    <?php
                      }
                      ?>
